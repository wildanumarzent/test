...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2020 at 12:09 PM
...
(3, '2020_06_23_073737_create_table_konsumen', 1),
(4, '2020_06_23_074957_create_table_transaksi', 1);
...
CREATE TABLE `table_transaksi` (
  `id` int(10) UNSIGNED NOT NULL,
  `konsumen` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis_kendaraan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `no_polisi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `table_transaksi`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `table_transaksi_konsumen_unique` (`konsumen`),
  ADD UNIQUE KEY `table_transaksi_no_polisi_unique` (`no_polisi`);
